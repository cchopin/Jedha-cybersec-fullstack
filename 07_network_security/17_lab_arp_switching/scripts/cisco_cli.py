...
Exemples:
  # Voir la table ARP
  python3 cisco_cli.py --host 192.168.139.14 --port 5000 --show "show ip arp"

  # Voir la table MAC
  python3 cisco_cli.py --host 192.168.139.14 --port 5000 --show "show mac address-table"

  # Exécuter des commandes
  python3 cisco_cli.py --host 192.168.139.14 --port 5000 --commands "enable;show ip arp"
